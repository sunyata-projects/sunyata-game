...
package org.sunyata.game.config;
...
import org.sunyata.game.majiang.core.mapper.UserRoomMapper;
import org.sunyata.game.store.currency.FundMapper;
import org.sunyata.game.store.order.OrderItemMapper;
import org.sunyata.game.store.order.OrderMapper;
import org.sunyata.game.store.order.ProductMapper;
import org.sunyata.game.store.user.UserMapper;
...
@MapperScan(basePackageClasses = {
        UserMapper.class,
        FundMapper.class, OrderItemMapper.class, OrderMapper.class, ProductMapper.class
        , RoomCheckIdPoolMapper.class, RoomMapper.class, UserRoomMapper.class}, sqlSessionFactoryRef =
        "adsSqlSessionFactory")
public class AdsDataSourceConfig {
    static final String PACKAGE = "org.sunyata.game.majiang.core.mapper";
    ...
    public SqlSessionFactory adsSqlSessionFactory(@Qualifier("adsDataSource") DataSource adsDataSource) throws
        ...
        bean.setTypeAliasesPackage("org.sunyata.game");
        bean.setTypeAliasesSuperType(MapperInterface.class);
