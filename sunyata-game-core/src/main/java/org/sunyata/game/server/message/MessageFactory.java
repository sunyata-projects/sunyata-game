...
public class MessageFactory {
    ...
    public static OctopusToUserRawMessage createToUserErrorMessage(int errorCode) {
        OctopusToUserRawMessage result = new OctopusToUserRawMessage();
        result.setCmd(99001);
        result.setSerial(1);
    ...
    public static OctopusPacketMessage createToUserErrorPacketMessage(int userIdInGateway, int sourceServerId, int
            destServerId, int errorCode) {
        return new OctopusPacketRawMessage()
                .setMessageType(-1)
                .setDataId(userIdInGateway)
                .setSourceServerId(sourceServerId)
                .setDestServerId(destServerId)
                .setRawMessage(MessageFactory.createToUserErrorMessage(errorCode));
    }
