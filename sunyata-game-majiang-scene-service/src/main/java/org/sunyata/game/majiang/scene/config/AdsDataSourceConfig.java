...
package org.sunyata.game.majiang.scene.config;
...
public class AdsDataSourceConfig {
    static final String PACKAGE = "org.sunyata.game.majiang.core.mapper";//org.sunyata.game.majiang.core.store";
    ...
    public SqlSessionFactory adsSqlSessionFactory(@Qualifier("adsDataSource") DataSource adsDataSource) throws
        ...
        bean.setTypeAliasesPackage("org.sunyata.game.majiang.core.mapper");
//        bean.setTypeAliasesPackage("com.zhongqi.model");
        ...
        try {
            //bean.setMapperLocations(resolver.getResources("classpath:room-mapper/*.xml"));
