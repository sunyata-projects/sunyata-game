...
import org.sunyata.game.majiang.core.models.majiang.UserPaiInfo;
import org.sunyata.game.majiang.core.models.message.GameRoomInfo;
import org.sunyata.game.majiang.core.models.message.GameUserInfo;
import org.sunyata.game.majiang.core.service.Room;

/**
 * @author leo on 16/10/6.
 */
public class RoomInfo {
    ...
    public RoomInfo(Room room, String rulesName) {
        chapter = MajiangChapterFactory.createMajiangChapter(room, rulesName); //new GuangDongMajiangChapter(room,
        // rulesName);
    }
...
//                Method writeMethod = BeanUtils.getPropertyDescriptor(GameUserInfo.class, "user" + i + "Distance")
// .getWriteMethod();
//
//                try {
