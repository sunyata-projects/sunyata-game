 ...
 */
public class GbRules extends Rules {
    private ArrayList<Pai> ALL_PAI_LIST;// = createAllList();
    private ArrayList<Pai> ALL_PAI_LIST_TUI_DAOHU;// = createSanYuanAndFengList();
    private ArrayList<Pai> ALL_PAI_LIST_GUI;// = createAllNumberList();
    ...
    private ArrayList<Pai> createAllList() {
        ArrayList<Pai> list = createAllNumberList();

//        list.add(Pai.SANYUAN_ZHONG);
//        list.add(Pai.SANYUAN_FA);
//        list.add(Pai.SANYUAN_BEI);
        list.addAll(createSanYuanAndFengList());
        allPaiLength = list.size();
        return list;
    }

    private ArrayList<Pai> createSanYuanAndFengList() {
        ArrayList<Pai> list = createAllNumberList();
    ...
    private static ArrayList<Pai> createAllNumberList() {
    ...
    public GbRules(RoomConfigInfo config) {
        super(config);
    }
    ...
    public boolean rest() {
        ...
        ALL_PAI_LIST_GUI = createAllNumberList();
        ALL_PAI_LIST_TUI_DAOHU = createSanYuanAndFengList();
