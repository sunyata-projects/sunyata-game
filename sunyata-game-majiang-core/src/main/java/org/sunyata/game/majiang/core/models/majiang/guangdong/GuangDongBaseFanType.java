 ...
 */
public enum GuangDongBaseFanType implements BaseFanTypeInterface {
    JI_HU("鸡胡", 1),
    ZI_MO("自摸", 2),
    DUI_DUI_HU("对对胡", 2),
    QI_DUI("七对子", 2),
    ...
    public static Map<BaseFanTypeInterface, FanInfo> getBaseFanMap() {
        return Arrays.stream(GuangDongBaseFanType.values()).collect(
    ...
    GuangDongBaseFanType(String name, int fan) {
        this.fan = fan;
        this.name = name;
    }
}
